    ...
    return (
        <footer className="bg-gray-800 text-gray-300 py-10 px-6 mt-10">
            ...
            <div className="text-center text-sm text-gray-500 mt-8 border-t border-gray-700 pt-4">
                &copy; {new Date().getFullYear()} My Shop. All rights reserved.<br /> Designed & Developed by Created by <strong onClick={() => router.push('https://github.com/Harsh1-shahu')} className='text-yellow-400 cursor-pointer'>Harsh Shahu</strong>
            </div>
