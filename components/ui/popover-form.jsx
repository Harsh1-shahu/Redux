  ...
  return (
    <div
      ...
      <motion.button
        ...
        className="flex h-9 items-center border bg-gray-400 dark:bg-white text-black px-3 text-sm font-bold shadow-xl">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className="absolute p-1 overflow-hidden bg-gray-400 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)]"
            ref={ref}
...
export function PopoverFormSuccess({
  ...
  return (
    <>
      ...
      <p
        className="text-sm text-white max-w-xs text-pretty mx-auto text-center">
        {description}
      </p>
    </>
  );
